...
func (AccountCardActive) Validate(account model.Account, transaction *model.Transaction) (CommitFunc, error) {
...
func (SufficientLimit) Validate(account model.Account, transaction *model.Transaction) (CommitFunc, error) {
